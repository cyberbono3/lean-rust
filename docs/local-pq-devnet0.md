...
| `LEAN_RUST_RUST_LOG` | `info,lean_rust=debug,lean_cli::startup=debug,lean_cli::node_config=debug,lean_cli::commands=debug,node=debug,runtime=debug,lean_wire=debug,libp2p_swarm=info,discv5=info` |
