//! [`P2pService`] — `crate::core::Service` impl driving the libp2p swarm.
//!
//! Lifecycle:
//! 1. [`DevnetHost::build`](crate::p2p::DevnetHost::build) constructs the
...
/// behind a single mutex so the typed [`crate::core::Service`] surface
...
impl P2pService {
    /// Construction entry point used by [`crate::p2p::DevnetHost::build`].
...
mod tests {
    use super::*;
    use crate::p2p::devnet::DevnetHost;
    use crate::p2p::options::HostOptions;
    use std::path::Path;
